...
def get_function_assurance_policy(maximum_score_exclude_no_fix: Optional[bool] = None,
...
def get_function_assurance_policy_output(maximum_score_exclude_no_fix: Optional[pulumi.Input[Optional[bool]]] = None,
