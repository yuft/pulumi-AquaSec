...
namespace Pulumi.Aquasec
{
    ...
    public partial class ImageAssurancePolicy : Pulumi.CustomResource
    {
    ...
    public sealed class ImageAssurancePolicyArgs : Pulumi.ResourceArgs
    {
        [Input("allowedImages")]
    ...
    public sealed class ImageAssurancePolicyState : Pulumi.ResourceArgs
    {
        [Input("allowedImages")]
        private InputList<string>? _allowedImages;
        public InputList<string> AllowedImages
