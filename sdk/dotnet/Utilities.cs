...
namespace Pulumi.Aquasec
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Aquasec.version.txt");
    ...
    internal sealed class AquasecResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AquasecResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
