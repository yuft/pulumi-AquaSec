...
export class FunctionAssurancePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionAssurancePolicyState, opts?: pulumi.CustomResourceOptions): FunctionAssurancePolicy {
        return new FunctionAssurancePolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aquasec:index/functionAssurancePolicy:FunctionAssurancePolicy';

    /**
     * Returns true if the given object is an instance of FunctionAssurancePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FunctionAssurancePolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FunctionAssurancePolicy.__pulumiType;
    }
    ...
    public readonly autoScanTimes!: pulumi.Output<outputs.FunctionAssurancePolicyAutoScanTime[]>;
    ...
    public readonly customChecks!: pulumi.Output<outputs.FunctionAssurancePolicyCustomCheck[] | undefined>;
    ...
    public readonly forbiddenLabels!: pulumi.Output<outputs.FunctionAssurancePolicyForbiddenLabel[] | undefined>;
    ...
    public readonly packagesBlackLists!: pulumi.Output<outputs.FunctionAssurancePolicyPackagesBlackList[] | undefined>;
    public readonly packagesWhiteListEnabled!: pulumi.Output<boolean | undefined>;
    public readonly packagesWhiteLists!: pulumi.Output<outputs.FunctionAssurancePolicyPackagesWhiteList[] | undefined>;
    ...
    public readonly requiredLabels!: pulumi.Output<outputs.FunctionAssurancePolicyRequiredLabel[] | undefined>;
    ...
    public readonly scopes!: pulumi.Output<outputs.FunctionAssurancePolicyScope[]>;
    public readonly trustedBaseImages!: pulumi.Output<outputs.FunctionAssurancePolicyTrustedBaseImage[] | undefined>;
     ...
     */
    constructor(name: string, args: FunctionAssurancePolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FunctionAssurancePolicyArgs | FunctionAssurancePolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FunctionAssurancePolicyState | undefined;
            ...
            const args = argsOrState as FunctionAssurancePolicyArgs | undefined;
        ...
        super(FunctionAssurancePolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FunctionAssurancePolicyState {
    ...
    autoScanTimes?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyAutoScanTime>[]>;
    ...
    customChecks?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyCustomCheck>[]>;
    ...
    forbiddenLabels?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyForbiddenLabel>[]>;
    ...
    packagesBlackLists?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyPackagesBlackList>[]>;
    packagesWhiteListEnabled?: pulumi.Input<boolean>;
    packagesWhiteLists?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyPackagesWhiteList>[]>;
    partialResultsImageFail?: pulumi.Input<boolean>;
    readOnly?: pulumi.Input<boolean>;
    registries?: pulumi.Input<pulumi.Input<string>[]>;
    registry?: pulumi.Input<string>;
    requiredLabels?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyRequiredLabel>[]>;
    ...
    scopes?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyScope>[]>;
    trustedBaseImages?: pulumi.Input<pulumi.Input<inputs.FunctionAssurancePolicyTrustedBaseImage>[]>;
 ...
 */
export interface FunctionAssurancePolicyArgs {
    allowedImages?: pulumi.Input<pulumi.Input<string>[]>;
    applicationScopes: pulumi.Input<pulumi.Input<string>[]>;
    assuranceType?: pulumi.Input<string>;
    auditOnFailure?: pulumi.Input<boolean>;
