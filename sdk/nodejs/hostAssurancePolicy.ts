...
export class HostAssurancePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HostAssurancePolicyState, opts?: pulumi.CustomResourceOptions): HostAssurancePolicy {
        return new HostAssurancePolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aquasec:index/hostAssurancePolicy:HostAssurancePolicy';

    /**
     * Returns true if the given object is an instance of HostAssurancePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HostAssurancePolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HostAssurancePolicy.__pulumiType;
    }
    ...
    public readonly autoScanTimes!: pulumi.Output<outputs.HostAssurancePolicyAutoScanTime[]>;
    ...
    public readonly customChecks!: pulumi.Output<outputs.HostAssurancePolicyCustomCheck[] | undefined>;
    ...
    public readonly forbiddenLabels!: pulumi.Output<outputs.HostAssurancePolicyForbiddenLabel[] | undefined>;
    ...
    public readonly packagesBlackLists!: pulumi.Output<outputs.HostAssurancePolicyPackagesBlackList[] | undefined>;
    public readonly packagesWhiteListEnabled!: pulumi.Output<boolean | undefined>;
    public readonly packagesWhiteLists!: pulumi.Output<outputs.HostAssurancePolicyPackagesWhiteList[] | undefined>;
    ...
    public readonly requiredLabels!: pulumi.Output<outputs.HostAssurancePolicyRequiredLabel[] | undefined>;
    ...
    public readonly scopes!: pulumi.Output<outputs.HostAssurancePolicyScope[]>;
    public readonly trustedBaseImages!: pulumi.Output<outputs.HostAssurancePolicyTrustedBaseImage[] | undefined>;
     ...
     */
    constructor(name: string, args: HostAssurancePolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HostAssurancePolicyArgs | HostAssurancePolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HostAssurancePolicyState | undefined;
            ...
            const args = argsOrState as HostAssurancePolicyArgs | undefined;
        ...
        super(HostAssurancePolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HostAssurancePolicyState {
    ...
    autoScanTimes?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyAutoScanTime>[]>;
    ...
    customChecks?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyCustomCheck>[]>;
    ...
    forbiddenLabels?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyForbiddenLabel>[]>;
    ...
    packagesBlackLists?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyPackagesBlackList>[]>;
    packagesWhiteListEnabled?: pulumi.Input<boolean>;
    packagesWhiteLists?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyPackagesWhiteList>[]>;
    partialResultsImageFail?: pulumi.Input<boolean>;
    readOnly?: pulumi.Input<boolean>;
    registries?: pulumi.Input<pulumi.Input<string>[]>;
    registry?: pulumi.Input<string>;
    requiredLabels?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyRequiredLabel>[]>;
    ...
    scopes?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyScope>[]>;
    trustedBaseImages?: pulumi.Input<pulumi.Input<inputs.HostAssurancePolicyTrustedBaseImage>[]>;
 ...
 */
export interface HostAssurancePolicyArgs {
    allowedImages?: pulumi.Input<pulumi.Input<string>[]>;
    applicationScopes: pulumi.Input<pulumi.Input<string>[]>;
    assuranceType?: pulumi.Input<string>;
    auditOnFailure?: pulumi.Input<boolean>;
